...
BoardView.prototype.bindEvents = function () {
  ...
  this.movePlayer('#space0');
};

BoardView.prototype.movePlayer = function (start) {
    PubSub.subscribe('Board:move-player', (evt) => {
      ...
      console.log(place);
      place.removeChild(this.player1Piece)
      document.querySelector(`#space${position}`).appendChild(this.player1Piece);
    });
